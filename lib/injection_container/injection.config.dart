...
import '../core/network_configration/dio_setup.dart' as _i133;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i69.AddAboutCleint>(_i69.AddAboutCleint(get<_i9.Dio>()));
  gh.singleton<_i70.AddAboutRepository>(_i71.AddAboutRepoImp(
    mapper: get<_i3.AddAboutMapper>(),
    cleint: get<_i69.AddAboutCleint>(),
  ));
  gh.factory<_i72.AddAboutUseCase>(
      () => _i72.AddAboutUseCase(repository: get<_i70.AddAboutRepository>()));
  gh.singleton<_i73.AddDeviceTokenCleint>(
      _i73.AddDeviceTokenCleint(get<_i9.Dio>()));
  gh.singleton<_i74.AddDeviceTokenRepository>(_i75.AddDeviceTokenRepositoryImpl(
    cleint: get<_i73.AddDeviceTokenCleint>(),
    mapper: get<_i4.AddDeviceTokenMapper>(),
  ));
  gh.factory<_i76.AddDeviceTokenUseCase>(() => _i76.AddDeviceTokenUseCase(
      addDeviceTokenRepository: get<_i74.AddDeviceTokenRepository>()));
  gh.singleton<_i77.AddLanguagesCleint>(
      _i77.AddLanguagesCleint(get<_i9.Dio>()));
  gh.singleton<_i78.AddLanguagesRepository>(_i79.AddLanguagesRepositoryImp(
    client: get<_i77.AddLanguagesCleint>(),
    mapper: get<_i5.AddLanguagesMapper>(),
  ));
  gh.factory<_i80.AddLanguagesUseCases>(() => _i80.AddLanguagesUseCases(
      addLanguagesRepository: get<_i78.AddLanguagesRepository>()));
  gh.singleton<_i81.AddReviewClient>(_i81.AddReviewClient(get<_i9.Dio>()));
  gh.singleton<_i82.AddReviewRepository>(_i83.AddReviewRepoImp(
    mapper: get<_i6.AddReviewMapper>(),
    cleint: get<_i81.AddReviewClient>(),
  ));
  gh.factory<_i84.AddReviewUseCase>(
      () => _i84.AddReviewUseCase(repository: get<_i82.AddReviewRepository>()));
  gh.singleton<_i85.CompleteRegistrationCleint>(
      _i85.CompleteRegistrationCleint(get<_i9.Dio>()));
  gh.singleton<_i86.CompleteRegistrationRepository>(
      _i87.CompleteRegistrationRepositoryImp(
    cleint: get<_i85.CompleteRegistrationCleint>(),
  ...
  gh.factory<_i88.CompleteRegistrationUseCases>(() =>
      _i88.CompleteRegistrationUseCases(
          completeRegistrationRepository:
              get<_i86.CompleteRegistrationRepository>()));
  gh.factory<_i89.CountriesCubit>(() => _i89.CountriesCubit(
      completeRegistrationUseCases: get<_i88.CompleteRegistrationUseCases>()));
  gh.singleton<_i90.CreateReservationCleint>(
      _i90.CreateReservationCleint(get<_i9.Dio>()));
  gh.singleton<_i91.CreateReservationRepository>(
      _i92.CreateReservationRepositoryImp(
    cleint: get<_i90.CreateReservationCleint>(),
    mappers: get<_i8.CreateReservationMappers>(),
  ));
  gh.factory<_i93.CreateReservationUseCase>(() => _i93.CreateReservationUseCase(
      createReservationRepository: get<_i91.CreateReservationRepository>()));
  gh.factory<_i89.EditDetailsCubit>(() => _i89.EditDetailsCubit(
      completeRegistrationUseCases: get<_i88.CompleteRegistrationUseCases>()));
  gh.singleton<_i94.EditNameProfileImageRepository>(
      _i95.EditNameProfilePhotoRepoImp(
    cleint: get<_i11.EditNameProfilePhotoClient>(),
    mappers: get<_i10.EditNameImageProfileMappers>(),
  ));
  gh.factory<_i96.EditNameProfileImageUseCase>(() =>
      _i96.EditNameProfileImageUseCase(
          repository: get<_i94.EditNameProfileImageRepository>()));
  gh.factory<_i89.EducationsCubit>(() => _i89.EducationsCubit(
      completeRegistrationUseCases: get<_i88.CompleteRegistrationUseCases>()));
  gh.singleton<_i97.ForgotResetPasswordRepository>(
      _i98.ForgotResetPasswordRepositoryImp(
    client: get<_i66.SendResetForgotPasswordClient>(),
    mapper: get<_i15.ForgotResetPasswordMapper>(),
  ));
  gh.factory<_i99.ForgotResetPasswordUseCases>(() =>
      _i99.ForgotResetPasswordUseCases(
          forgotResetPasswordRepository:
              get<_i97.ForgotResetPasswordRepository>()));
  gh.factory<_i89.GetAllServicesCubit>(() => _i89.GetAllServicesCubit(
      useCase: get<_i88.CompleteRegistrationUseCases>()));
  gh.singleton<_i100.GetAssistantRepository>(
      _i101.GetAllAssistantsRepositoryImpl(
    client: get<_i16.GetAllAssistantsClient>(),
    mapper: get<_i23.GetAssistantsMapper>(),
  ));
  gh.factory<_i102.GetAssistantReservationCubit>(() =>
      _i102.GetAssistantReservationCubit(
          useCase: get<_i22.GetAssistantReservationUsecase>()));
  gh.factory<_i103.GetAssistantUseCase>(() => _i103.GetAssistantUseCase(
      getAssistantRepository: get<_i100.GetAssistantRepository>()));
  gh.factory<_i104.GetAssistantsCubit>(() => _i104.GetAssistantsCubit(
      getAssistantUseCase: get<_i103.GetAssistantUseCase>()));
  gh.factory<_i89.GetCitiesInCountryCubit>(() => _i89.GetCitiesInCountryCubit(
      useCase: get<_i88.CompleteRegistrationUseCases>()));
  gh.factory<_i105.GetCustomerInfoCubit>(() =>
      _i105.GetCustomerInfoCubit(useCase: get<_i34.GetCustomerUseCase>()));
  gh.factory<_i106.GetCustomerReservationCubit>(() =>
      _i106.GetCustomerReservationCubit(
          useCase: get<_i33.GetCustomerReservationUsecase>()));
  gh.singleton<_i107.GetFreeDayRepository>(_i108.GetFreeDaysRepositoryImp(
    cleint: get<_i35.GetFreeDaysCleint>(),
    mappers: get<_i36.GetFreeDaysMappers>(),
  ));
  gh.factory<_i109.GetFreeDaysUsecase>(() => _i109.GetFreeDaysUsecase(
      getFreeDayRepository: get<_i107.GetFreeDayRepository>()));
  gh.factory<_i110.GetReviewsCubit>(() =>
      _i110.GetReviewsCubit(getReviewsUseCase: get<_i41.GetReviewsUseCase>()));
  gh.factory<_i111.GetUsedLanguagesCubit>(() => _i111.GetUsedLanguagesCubit(
      getUsedLanguagesUseCase: get<_i46.GetUsedLanguagesUseCase>()));
  gh.factory<_i112.GetUsedServicesCubit>(() => _i112.GetUsedServicesCubit(
      getUsedServicesUseCase: get<_i51.GetUsedServicesUseCase>()));
  gh.factory<_i113.InsertFreeDaysCubit>(() => _i113.InsertFreeDaysCubit(
      insertFreeDaysUseCase: get<_i56.InsertFreeDaysUseCase>()));
  gh.singleton<_i114.PersonalAssistantHomePageRepository>(
      _i115.PersonalAssistantHomepageRepositoryImp(
    cleint: get<_i59.PesonalAssistantCleint>(),
    mappers: get<_i58.PersonalAssistantHomePageMappers>(),
  ));
  gh.factory<_i116.PersonalAssistantHomePageUseCases>(() =>
      _i116.PersonalAssistantHomePageUseCases(
          personalAssistantHomePageRepository:
              get<_i114.PersonalAssistantHomePageRepository>()));
  gh.singleton<_i117.RegistrationRepository>(_i118.RegistrationRepositoryImpl(
  ...
  gh.factory<_i119.RegistrationUseCases>(() => _i119.RegistrationUseCases(
      registrationRepository: get<_i117.RegistrationRepository>()));
  gh.factory<_i120.RemoveDeviceTokenCubit>(() => _i120.RemoveDeviceTokenCubit(
      usecase: get<_i65.RemoveDeviceTokenUsecase>()));
  gh.factory<_i121.ResetPasswordCubit>(() => _i121.ResetPasswordCubit(
      forgotResetPasswordUseCases: get<_i99.ForgotResetPasswordUseCases>()));
  gh.factory<_i122.SignInCubit>(
      () => _i122.SignInCubit(useCases: get<_i119.RegistrationUseCases>()));
  gh.factory<_i123.SignUpCubit>(
      () => _i123.SignUpCubit(useCases: get<_i119.RegistrationUseCases>()));
  gh.factory<_i124.AddAboutCubit>(
      () => _i124.AddAboutCubit(useCase: get<_i72.AddAboutUseCase>()));
  gh.factory<_i125.AddDeviceTokenCubit>(() =>
      _i125.AddDeviceTokenCubit(useCase: get<_i76.AddDeviceTokenUseCase>()));
  gh.factory<_i126.AddLanguagesCubit>(() => _i126.AddLanguagesCubit(
      addLanguagesUseCases: get<_i80.AddLanguagesUseCases>()));
  gh.factory<_i127.AddReviewCubit>(
      () => _i127.AddReviewCubit(useCase: get<_i84.AddReviewUseCase>()));
  gh.factory<_i89.AllLanguagesCubit>(() => _i89.AllLanguagesCubit(
      completeRegistrationUseCases: get<_i88.CompleteRegistrationUseCases>()));
  gh.factory<_i128.CreateReservationCubit>(() => _i128.CreateReservationCubit(
      useCase: get<_i93.CreateReservationUseCase>()));
  gh.factory<_i129.EditNameProfileImageCubit>(() =>
      _i129.EditNameProfileImageCubit(
          useCase: get<_i96.EditNameProfileImageUseCase>()));
  gh.factory<_i130.ForgotPasswordCubit>(() => _i130.ForgotPasswordCubit(
      forgotResetPasswordUseCases: get<_i99.ForgotResetPasswordUseCases>()));
  gh.factory<_i131.GetFreeDaysCubit>(() => _i131.GetFreeDaysCubit(
      getFreeDaysUsecase: get<_i109.GetFreeDaysUsecase>()));
  gh.factory<_i132.PersonalAssistantHomePageCubit>(() =>
      _i132.PersonalAssistantHomePageCubit(
          personalAssistantHomePageUseCases:
              get<_i116.PersonalAssistantHomePageUseCases>()));
  return get;
}

class _$DioSetup extends _i133.DioSetup {}
