...
import 'package:flutter/material.dart';
  ...
  class _SchedulePageState extends State<SchedulePage> {
                                        ...
                                        return BlocConsumer<InsertFreeDaysCubit, Result<InsertFreeDaysEntity>>(
                                            listener: (context, state) => state.when(
                                                        ...
                                                        (id) =>
                                                          ...
                                                          (bearer) => BlocProvider
                                                            ...
                                                            weeks: ref.watch(
                                                                ...
                                                                0,
                                                            free_days:jsonEncode(ref.watch(selectedFreeDays))
                                                          ),
                                                        ),
                                                      );
                                                ...
                                                success: (success) {
                                                  ...
                                                  }else if(success is InsertFreeDaysEntity && success.code=="422"){
                                                     AppDialogs.errorDialogWithOutConfirmButton(context, error: success.message.error[0]);
                                                  }else if(success is InsertFreeDaysEntity && success.code=="500"){
                                            ...
                                            builder: (context, state) {
                                              if (state is Loading) {
                                                ...
                                                return AppButtons(
                                                  ...
                                                  onPressed: () { print(ref.watch(hourlyRateProvider));
                                                    print(ref.watch(selectedFreeDays));
                                                    print(ref.watch(selectedNumberOfWeeks));
                            ...
                            children: [
                              ...
                              Consumer(builder: (context, ref, _) {
                                return TextFieldWidget(
                                  hintText: ref.watch(hourlyRateProvider)==''?'Payment per hour'
                                      :ref.watch(hourlyRateProvider),
    ...
    Future<void> displayTimeDialog() async {
      final TimeOfDay? time = await showTimePicker(context: context, initialTime: TimeOfDay.now(), initialEntryMode: TimePickerEntryMode.dialOnly
