                          ...
                          children: [
                            ...
                            CustomDropdownWidget(
                              ...
                              onPressed: () {
                                ...
                                if (ref.watch(showAddressList) == true) {
                            ...
                            Consumer(
                              builder: (context,ref,_) {
                                return CompleteRegistrationTextField(
                                  hintText: 'Phone number',
                                  onChanged: (c) {
                                    ref.watch(phoneNumberCompleteRegistrationProvider.notifier).state=c;
                                  },
                                  validator: (v) {},
                                );
                              }
                            ...
                            BlocConsumer<EditDetailsCubit,
                                Result<EditUserDetailsEntity>>(
                                        ...
                                        onPressed: () {
                                            BlocProvider.of<EditDetailsCubit>(
                                              ...
                                              .editDetails(
                                                ...
                                                profile_image:null,//(ref.watch(uploadedImage).path),
                                                about: null,
                                                city_id: null,
                                                country_id:null ,//ref.watch(countryId),
                                                is_male: null,
                                                location: null, 
                                              );
                                        },
                        ...
                        Column(
                          children: [
                            ...
                            AnimatedContainer(
                                ...
                                height:
                                    ref.watch(showLanguagesList) ? 127.h : 0,
                                width: double.infinity,
                                decoration: BoxDecoration(
                                  color:
                                ...
                                child: BlocBuilder<AllLanguagesCubit,
                                    Result<AllLanguagesEntity>>(
                                  builder: (context, state) => state.when(
                                    () => Container(),
                                    loading: () => const Center(
                                        child: CircularProgressIndicator(
